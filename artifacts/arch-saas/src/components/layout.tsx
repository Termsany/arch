...
import { LayoutDashboard, Users, FolderOpen, CreditCard, Building2, Tag, LogOut, Menu, BarChart3 } from "lucide-react";
...
const ALL_NAV_ITEMS = [
  ...
  { href: "/reports", label: "التقارير", icon: BarChart3, superAdminOnly: false },
