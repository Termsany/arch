...
const ALL_NAV_ITEMS = [
  { href: "/dashboard", label: "لوحة التحكم", icon: LayoutDashboard, superAdminOnly: false, officeOnly: false },
...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  if (location === "/" || location === "/login" || location === "/client/login" || location === "/pricing" || location === "/start") {
    return <>{children}</>;
  }
